    ...
    <div className="bg-dark1 p-10">
      <Container>
        <div className="text-white flex">
          <div className="hidden w-1/3 lg:block bg-dark1 h-[500px] hide-bar overflow-y-scroll p-20">
          ...
          <div className="bg-dark2 p-10 flex-1 text-center rounded-3xl">
            ...
            <h2 className="mt-10 text-4xl font-bold underline">
              Sponsored Server
            </h2>
